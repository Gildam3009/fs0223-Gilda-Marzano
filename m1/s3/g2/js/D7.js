...
function concatenaStringhe(Hello,World) {
  let str1=Hello.split("")
  let str2=World.split("")

let prime2= str1.splice (0,2)
let ultime3= str2.splice (str1.length-3,3)


str1=prime2.join("")
str2+=ultime3.join("")

let result=prime2+ultime3
...
console.log(concatenaStringhe("Hello","World"))
...
let array = [1, 2, 3, 4, 5, 6, 98, 47, 53, 99]

function filterArray(array) {
  return array.filter(function (pari) {
    return pari % 2 == 0;
  });
}
